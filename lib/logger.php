...
class Logger
{
    ...
    public static function createLogFile()
    {
        ...
        //static::$log_file = "/var/www/html/bacaleg/lib/logs/bacaleg-log-{$time}.txt";
        static::$log_file = "d:/xampp/htdocs/bacaleg/manager/lib/logs/bacaleg-log-{$time}.txt";


        //Check if directory /logs exists
        if (!file_exists('/var/www/html/bacaleg/lib/logs')) {
            mkdir(__DIR__ . '/logs', 0777, true);
        }

        //Create log file if it doesn't exist.
        if (!file_exists(static::$log_file)) {
            // $file_dir = "/Applications/xampp/htdocs/pkb/logs/bacaleg/manager-log-{$time}.txt";
            // static::$log_file = $file_dir; 
